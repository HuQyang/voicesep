...
def main():
    ...
    # file_nm = "钱部长数据融合沟通"
    ap.add_argument("--input",default=f"result/{file_nm}_seacopara2_1.json", 
                    help="ASR 输出: .json (simple/firered) 或 .txt")
    ap.add_argument("--output", default=f"result/{file_nm}_seacopara2_1_medium.txt", help="清洁后的 .txt")
    ap.add_argument("--output-json", default=f"result/{file_nm}_seacopara2_1_medium.json",
